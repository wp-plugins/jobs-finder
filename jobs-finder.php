...
define(jobs_finder_READER_URL_RSS_DEFAULT, 'http://jobs.onlinerel.com/feed/');
define(jobs_finder_READER_TITLE, 'Jobs Finder');
define(jobs_finder_MAX_SHOWN_ITEMS, 10);
define(jobs_finder_DESCRIPTION_COUNT_CHARS, 500);
...
function jobs_finder_widget_ShowRss($args)
{
	...
	if( $options == false ) {
		$options[ 'jobs_finder_widget_url_title' ] = jobs_finder_READER_TITLE;
		$options[ 'jobs_finder_widget_RSS_url' ] = jobs_finder_READER_URL_RSS_DEFAULT;
		$options[ 'jobs_finder_widget_RSS_count_items' ] = jobs_finder_MAX_SHOWN_ITEMS;
	}

 $RSSurl = jobs_finder_READER_URL_RSS_DEFAULT;
...
function jobs_finder_widget_Admin()
{
	...
	//default settings
	if( $options == false ) {
		$newoptions[ 'jobs_finder_widget_url_title' ] = jobs_finder_READER_TITLE;
		$newoptions[ 'jobs_finder_widget_RSS_url' ] = jobs_finder_READER_URL_RSS_DEFAULT;
	...
	$jobs_finder_widget_RSS_url = jobs_finder_READER_URL_RSS_DEFAULT;	
